...
def create_candidature():
    ...
    try:
        ...
        required_fields = ['name', 'email', 'spi', 'phone']
        ...
        # Processar uploads
        uploaded_files = {}
        file_fields = ['document_front', 'document_back', 'residence_proof']
        
        for field in file_fields:
            if field in request.files:
                file = request.files[field]
                if file and file.filename:
                    filename = secure_filename(f"{data.get('name', 'user')}_{field}_{file.filename}")
        ...
        candidature = Candidature(
            ...
            document_front=uploaded_files.get('document_front'),
            document_back=uploaded_files.get('document_back'),
            residence_proof=uploaded_files.get('residence_proof'),
            terms_accepted=data.get('terms_accepted') == 'on',
            validity_confirmed=data.get('validity_confirmed') == 'on'
        )
